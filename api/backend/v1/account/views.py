...
from library.constant.file_check import LIMIT_SIZE_IMAGE
from library.functions import convert_to_dict, convert_to_int, is_mobile_valid
from library.service.functions import CHATTING_SERVICE_HEAR, request_api
from library.service.service_urls import SERVICE_CHATTING_CREATE_URL
        ...
        if user_id:
            ...
            if camera_obj:
                ...
                if len(camera_check) != len(list_camera_id):
                    return self.validate_exception("Some camera is not exists!")
